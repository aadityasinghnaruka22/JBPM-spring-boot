...
//	public void sendSignalToProcessInstance(String containerId, long processInstanceId, String signalName) {
//        try (KieServicesClient kieServicesClient = KieServicesFactory.newKieServicesClient(kieServicesConfiguration, new EnteredCredentialsProvider())) {
//            ProcessServicesClient processServicesClient = kieServicesClient.getServicesClient(ProcessServicesClient.class);
//            processServicesClient.signalProcessInstance(containerId, processInstanceId, signalName);
//        } catch (Exception e) {
//            // Handle exceptions
//            e.printStackTrace();
//        }
